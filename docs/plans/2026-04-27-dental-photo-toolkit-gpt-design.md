...
| Watermark on output board | "Generated with Dental Photo Toolkit · Pablo Atria" — 6pt figure-legend style, bottom-right, subtle. Toggleable via "remove watermark" follow-up. |
